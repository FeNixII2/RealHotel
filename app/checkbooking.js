module.exports = function (app, con, moment, transporter) {
    ...
    app.post("/get_reserv_info", (req, res) => {
        ...
        ,roomstype.count_humen,roomstype.extional,payment.pay_type,booking_status.status_name from reserved
        ...
        LEFT JOIN booking_status ON reserved.status = booking_status.status_id
